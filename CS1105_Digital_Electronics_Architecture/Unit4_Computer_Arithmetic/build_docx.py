#!/usr/bin/env python3
"""
Generate the APA .docx files for CS 1105 Unit 4 (Computer Arithmetic) from the
Markdown sources, so the .md and .docx never drift apart. Double-spaced Times
...
Output: Discussion/Unit4_Discussion_Post.docx
        Assignment/Unit4_Assignment_Activity.docx
"""
